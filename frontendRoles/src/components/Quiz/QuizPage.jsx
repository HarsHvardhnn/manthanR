  ...
  return (
    <>
      ...
      <div className="px-4 md:px-8 lg:px-40 py-4 pt-28 min-h-svh sm:min-h-screen font-montserrat bg-blue-50">
        <div className="flex flex-col md:flex-row items-center mb-10">
          <div className="md:w-7/12 md:mr-4 mb-4 md:mb-0">
            ...
            <p className="text-sm font-medium lg:text-base">
              ...
              valuable insights about yourself and highlight areas where you can
              grow. Each category provides a unique opportunity to reflect on
              your well-being and understand your habits better. By taking the
              time to explore these offerings, you can empower yourself on your
        ...
        <h2 className="text-3xl font-bold text-gray-800 mt-10 mb-8 border-gray-300 border-b pb-2">
          Available Quizzes
        </h2>
