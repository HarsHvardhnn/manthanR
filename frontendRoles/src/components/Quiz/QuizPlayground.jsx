...
const QuizPlayground = () => {
  ...
  if (showResult) {
    ...
    return (
      <div className="bg-blue-50 min-h-screen pt-28">
        <Header />
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6 text-center font-montserrat">
  ...
  return (
    <div className="bg-blue-50 min-h-screen pt-28">
      <Header />
      <div className="max-w-2xl mx-auto rounded-lg shadow-lg p-6 bg-white font-montserrat">
              ...
              <li
                ...
                className={`p-4 rounded-lg cursor-pointer text-gray-700 ${
                  answers[currentQuestionIndex] === option.score
                    ...
                    : "bg-white"
                } hover:bg-blue-600 border border-gray-200 hover:text-white transition-colors`}
                onClick={() => {
        ...
        <div className="flex justify-between mt-8">
          <button
            ...
            className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:pointer-events-none disabled:bg-gray-300 disabled:text-gray-600"
