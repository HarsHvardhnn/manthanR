...
const UserSection = () => {
  ...
  const getAdmin = () => {
    ...
    console.log(token);
      ...
      axios
        .get(`http://localhost:4000/v1/get-user-info/${user.assigned_admin}`, {  headers: {
          ...
          <div className="">
            ...
            <div className="h-3/5 flex flex-wrap justify-around w-11/12 sm:w-10/12 mx-auto rounded-xl mt-6 sm:mt-10">
              ...
              >
                ...
                <div className="txt text-sm sm:text-xl font-medium">View Profile</div>
              </button>
              <button
                onClick={() => {
                  navigate("/ChatBot");
              ...
              >
                ...
                <div className="text-sm sm:text-xl font-medium">Start Survey</div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-sm sm:text-xl font-medium">Admin Details</div>
              </button>
            </div>
          </div>
        </div>
